...
[We](https://awesomebible.de) are building [a bible app](https://docs.awesomebible.de/en/myawesomebible/), so we want to create a format that is easy to work with and can scale to as many bible translations as you want.
